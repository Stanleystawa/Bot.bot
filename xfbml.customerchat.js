/*1709232761,,JIT Construction: v1011742130,en_US*/
 ...
 */
                ...
                __d("sdk.domReady", [], (function(a, b, c, d, e, f) {
                    ...
                    c || (g = [],
                    document.addEventListener ? (document.addEventListener("DOMContentLoaded", a, !1),
                    window.addEventListener("load", a, !1)) : document.attachEvent && (document.attachEvent("onreadystatechange", a),
                ...
                __d("sdk.Content", ["Log", "sdk.UA", "sdk.domReady"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h, i;
                    function j(a, b) {
                        b || (!h ? (h = b = document.getElementById("fb-root"),
                        b || (d("Log").warn('The "fb-root" div has not been created, auto-creating'),
                        h = b = document.createElement("div"),
                        b.id = "fb-root",
                        c("sdk.UA").ie() || !document.body ? c("sdk.domReady")(function() {
                            b && document.body && document.body.appendChild(b)
                        }) : document.body.appendChild(b)),
                        b.className += " fb_reset") : b = h);
                        b.appendChild(a);
                        return a
                    }
                    function k(a) {
                ...
                __d("sdk.DOM", ["guid", "sdk.domReady"], (function(a, b, c, d, e, f, g) {
                    ...
                    function o(a, b, d) {
                        ...
                        if (d != null && d.nodeType === 11) {
                            var f = d;
                            f.host.id != null && i[f.host.id] != null ? e = i[f.host.id] : (f.host.id || (f.host.id = c("guid")()),
                            e = {},
                            i[f.host.id] = e)
                        } else
                            e = h;
                ...
                __d("normalizeError", ["sdk.UA"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a) {
                        ...
                        c("sdk.UA").chrome() && a && (b.script = a[1],
                        b.line = parseInt(a[2], 10));
                        for (a in b)
                            b[a] == null && delete b[a];
                        return b
                    }
                ...
                __d("Type", ["Assert"], (function(a, b, c, d, e, f) {
                    ...
                    function i(a, b) {
                        ...
                        for (a = 0; a < b.length; a++) {
                            var d = b[a];
                            typeof d === "function" && (c.__mixins.push(d),
                            d = d.prototype);
                ...
                __d("sdk.ErrorHandler", ["ManagedError", "normalizeError", "sdk.Runtime", "wrapFunction"], (function(a, b, c, d, e, f, g) {
                    function a(a, b) {
                        ...
                        function f(b, f) {
                            return function() {
                                ...
                                try {
                                    ...
                                    if (a instanceof c("ManagedError"))
                                        throw a;
                        ...
                        a && (setTimeout = i(setTimeout, "setTimeout"),
                ...
                __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Content", "sdk.DOM", "sdk.ErrorHandling", "sdk.domReady"], (function(a, b, c, d, e, f, g) {
                    ...
                    c("sdk.domReady")(function() {
                        ...
                        c("JSSDKCssConfig").rules && d("sdk.DOM").addCssRules(c("JSSDKCssConfig").rules, c("JSSDKCssConfig").components)
                    });
                    function j(a, b, d, e) {
                        return c("sdk.ErrorHandling").guard(function() {
                            ...
                            var f = Array.prototype.slice.call(arguments).map(d), g = a.apply(e, f), h, i = !0;
                    ...
                    function a(a, b) {
                        ...
                        Object.keys(b).forEach(function(c) {
                            ...
                            if (typeof e === "function") {
                                ...
                                (typeof e === "object" || typeof e === "number") && (d[c] = e)
                        })
                    }
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "sdk.Model", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    ...
                    function B(a) {
                        ...
                        for (var b in a)
                            c("Assert").isTrue(m.test(b) || ES(s, "includes", !0, b), "Invalid user properties key name: " + b + ". It must be between 1 and " + n + " characters, and must contain only alphanumerics, _, - or spaces, starting with alphanumeric or _. Or, it must be a pre-defined user property"),
                            c("Assert").isTrue(a[b].toString().length <= r, "Invalid user properties value: " + a[b] + ". It must be no longer than " + r + " characters.")
                    }
                    function C(a) {
                    ...
                    function E(a) {
                        ...
                        c("Assert").isTrue(a.length <= o, "Invalid user ID: " + a + ". It must be no longer than " + o + " characters.")
                    }
                    a = Object.freeze({
                        logEvent: u,
                        logPurchase: a,
                ...
                __d("sdk.Event", [], (function(a, b, c, d, e, f) {
                    "use strict";
                    var g = "event.subscribe", h = "event.unsubscribe", i;
                    function j() {
                        i || (i = {});
                        return i
                    }
                ...
                __d("sdk.AppEvents-public", ["Assert", "FB", "sdk.AppEvents", "sdk.Event", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    function a() {
                        d("sdk.Event").subscribe("init:post", function(a) {
                            c("sdk.Runtime").getClientID() && (a.autoLogAppEvents !== void 0 && (c("Assert").isBoolean(a.autoLogAppEvents, "Type of property autoLogAppEvents must be boolean"),
                ...
                __d("sdk.Cookie", ["QueryString", "sdk.Runtime", "sdk.Scribe", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    function j(a, b, e, f) {
                        ...
                        var g = h !== null && h !== ".";
                        g && (document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT" + f,
                ...
                __d("sdk.AuthUtils", ["sdk.AuthState", "sdk.Cookie", "sdk.Observable", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    ...
                    function f(a) {
                        a != null ? (c("sdk.Runtime").setGraphDomain(a),
                        a == "instagram" && c("sdk.Runtime").setIsVersioned(!1)) : c("sdk.Runtime").setGraphDomain("")
                    }
                    function i() {
                ...
                __d("sdk.AuthStorageUtils", ["sdk.AuthUtils", "sdk.Runtime", "sdk.WebStorage", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    function f() {
                        ...
                        if (c("sdk.Runtime").getUseLocalStorage()) {
                            ...
                            e && (a = e.getItem(d("sdk.AuthUtils").AuthConstants.LOCAL_STORAGE_TOKEN_PREFIX + c("sdk.Runtime").getClientID()),
                            b = e.getItem(d("sdk.AuthUtils").AuthConstants.IG_LOCAL_STORAGE_TOKEN_PREFIX + c("sdk.Runtime").getClientID()))
                        }
                        return {
                            fbToken: a,
                            igToken: b
                    ...
                    function i() {
                        ...
                        if (a) {
                            ...
                            if (a != null)
                                try {
                                    a = ES("JSON", "parse", !1, a);
                                    if (a != null && a.expiresAt != null && a.expiresAt > Date.now())
                                        return a
                                } catch (a) {
                                    return null
                                }
                ...
                __d("insertIframe", ["GlobalCallback", "getBlankIframeSrc", "guid"], (function(a, b, c, d, e, f, g) {
                    function a(a) {
                        var b = a.id != null ? a.id : c("guid")()
                          ...
                          , h = function() {
                            f && !g && (g = !0,
                            typeof a.onload === "function" && a.onload(a.root.firstChild))
                        }
                ...
                __d("sdk.Impressions", ["Miny", "QueryString", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    function h(a, b) {
                        ...
                        if (g.length > 2e3 && (a.payload && typeof a.payload === "string")) {
                            var h = a.payload
                              , k = c("Miny").encode(h);
                            k && k.length < h.length && (a.payload = k,
                            g = c("QueryString").appendToUrl(e, a))
                        }
                ...
                __d("sdk.Auth.LoginStatus", ["Log", "QueryString", "sdk.Auth", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Cookie", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.feature", "sdk.statusCORS"], (function(a, b, c, d, e, f, g) {
                    ...
                    function j(a, b, e) {
                        ...
                        if (c("sdk.Runtime").getShouldLoadFamilyLogin() && c("sdk.feature")("should_enable_ig_login_status_fetch", !1))
                            if (b != null)
                                c("sdk.statusCORS").getLoginStatusCORS(e, b, c("sdk.AuthState").getState().currentAuthResponse, "instagram");
                            else {
                                a = {
                                    authResponse: null,
                                    status: "unknown",
                        ...
                        if (c("sdk.Runtime").getLoginStatus() !== "connected" && (document.referrer === "" || h.test(document.referrer))) {
                            ...
                            if (f !== "") {
                                ...
                                if (window == top && b != null) {
                                    ...
                                    a = function(a) {
                                        var d;
                                        a != null && a.status === "connected" && ((d = a.authResponse) == null ? void 0 : d.accessToken) === b && (delete g.access_token,
                                        delete g.code,
                ...
                __d("sdk.Auth", ["Log", "UrlMap", "isStringNullOrEmpty", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Cookie", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.ui"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h = 5 * 1e3;
                    function a(a, b) {
                        b && b.perms && !b.scope && (b.scope = b.perms,
                        delete b.perms,
                        d("Log").warn("OAuth2 specification states that 'perms' should now be called 'scope'.  Please update."));
                    ...
                    function e(a) {
                        (a == null ? void 0 : a.shouldSetAuthResponse) !== !1 && ((a == null ? void 0 : a.status) === "connected" && d("sdk.AuthUtils").setRevalidateTimer(),
                        j(a == null ? void 0 : a.authResponse, i(a == null ? void 0 : a.status), a == null ? void 0 : a.loginSource));
                    ...
                    function l(a, b, e, f) {
                        return function(e) {
                            if (e && (e.access_token || e.code)) {
                                ...
                                e && e.result && (d("sdk.AuthUtils").removeLogoutState(),
                        ...
                        c.stub = function(a) {
                            ...
                            this.remote[a] = function() {
                                ...
                                for (var d = arguments.length, e = new Array(d), f = 0; f < d; f++)
                                    e[f] = arguments[f];
                                typeof e[e.length - 1] === "function" && (c.id = ++b.$1,
                                b.$2[c.id] = e.pop());
                                c.params = e;
                ...
                __d("sdk.DialogUtils", ["DOMEventListener", "sdk.Content", "sdk.DOM", "sdk.UA"], (function(a, b, c, d, e, f, g) {
                    ...
                    function e(a, b, c) {
                        ...
                        return d("DOMEventListener").add(a, "mouseenter", function() {
                            ...
                            f || (f = d("DOMEventListener").add(a, "mouseleave", function() {
                                g()
                            }))
                        })
                    }
                    ...
                    function l(a, b, e) {
                        ...
                        }, m = d("sdk.DOM").getViewportInfo(), n = l(a.offsetWidth);
                        l = l(a.offsetHeight);
                ...
                __d("sdk.Dialog", ["DOMEventListener", "ObservableMixin", "Type", "sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Runtime", "sdk.UA", "sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    ...
                    var n = c("Type").extend({
                        constructor: function(a, b) {
                            ...
                            this.display = b,
                            this._e2e = {},
                            o._dialogs || (o._dialogs = {},
                            o._addOrientationHandler()),
                            o._dialogs[a] = this,
                        ...
                        trackEvents: function(a) {
                            ...
                            for (var b in a)
                                Object.prototype.hasOwnProperty.call(a, b) && this.trackEvent(b, a[b]);
                            return this
                        }
                    }, c("ObservableMixin"))
                      , o = {
                        ...
                        _findRoot: function(a) {
                            a = a;
                            while (a) {
                                if (d("sdk.DOM").containsCss(a, "fb_dialog"))
                                    return a;
                        ...
                        _showTabletOverlay: function(a) {
                            ...
                            if (o._overlayEl == null) {
                                ...
                                o._overlayEl.className = ""
                        },
                        _hideTabletOverlay: function() {
                            o.isTabletStyle() && (o._overlayEl != null && (o._overlayEl.className = "hidden"),
                        ...
                        _makeActive: function(a) {
                            ...
                            o._lowerActive(),
                            o._active = a,
                            c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.CANVAS) && c("sdk.Canvas.Environment").getPageInfo(function(a) {
                                o._centerActive(a)
                            }),
                            o._centerActive()
                        },
                        ...
                        _setDialogSizes: function(a) {
                            ...
                            for (var b in o._dialogs)
                                if (Object.prototype.hasOwnProperty.call(o._dialogs, b)) {
                                    ...
                                    d && (d.style.width = o.getDefaultSize().width + "px",
                        ...
                        remove: function(a) {
                            ...
                            if (b) {
                                ...
                                o._removeStacked(b);
                                a ? (o._hideLoader(),
                                o._stack.length > 0 ? o.show(o._stack.pop()) : (o._lowerActive(),
                                d("sdk.DialogUtils").onDialogHideCleanup(o.isTabletStyle()),
                                o._hideTabletOverlay())) : o._active === null && o._stack.length > 0 && o.show(o._stack.pop());
                                window.setTimeout(function() {
                                    var a;
                        ...
                        for (var c in a)
                            if (Object.prototype.hasOwnProperty.call(a, c)) {
                                ...
                                if (d == null)
                                    ...
                                    typeof d === "string" ? b[c] = d : b[c] = ES("JSON", "stringify", !1, d)
                            }
                        return b
                    }
                    f["default"] = a
                ...
                __d("ApiBatcher", ["invariant", "ApiClientUtils", "QueryString", "sdk.safelyParseResponse", "whitelistObjectKeys"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    a = function() {
                        ...
                        b.scheduleBatchCall = function() {
                            ...
                            this.$1.push(l);
                            this.$2.push(h);
                            this.$1.length == i ? (this.$4 && window.clearTimeout(this.$4),
                            this.$5()) : this.$4 || (this.$4 = window.setTimeout(function() {
                                b.$5()
                            }, 0))
                        }
                        ;
                ...
                __d("CORSRequest", ["Log", "QueryString", "RequestConstants", "sdk.Cookie", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a, b, e, f, g) {
                        ...
                        b !== "post" && (a = c("QueryString").appendToUrl(a, i),
                        i = "");
                        e = h(b, a, g);
                        if (!e)
                            return !1;
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "CORSRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function(a, b, c, d, e, f, g) {
                    var h, i, j, k = [], l = !1, m = 2e3, n = {
                        ...
                        stream_get: !0,
                        users_getinfo: !0
                    }, o = ["cors"], p = 0, q = [], r = 0, s = 0, t, u = d("Log");
                    function v(a, b, d, e) {
                        var f = r !== 0 && p >= r;
                        if (f) {
                            q.push(function() {
                        ...
                        m = Object.keys(i);
                        m.length > 0 && (a = c("QueryString").appendToUrl(a, i),
                    ...
                    var y = ES("Object", "assign", !1, new (c("ObservableMixin"))(), {
                        setAccessToken: function(a) {
                            h && a && h !== a && u.error("You are overriding current access token, that means some other app is expecting different access token and you will probably break things. Please consider passing access_token directly to API parameters instead of overriding the global settings."),
                            h = a
                        },
                        ...
                        setClientID: function(a) {
                            i && i !== a && u.warn("Warning: Two different applications have attempted to set the client ID. Overriding the previously set client ID."),
                            i = a
                        },
                ...
                __d("sdk.PlatformVersioning", ["ManagedError", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        if (!c("sdk.Runtime").getVersion())
                            throw new (c("ManagedError"))("init not called with valid version")
                    }
                    function b(a) {
                        if (!h.test(a))
                ...
                __d("sdk.warnInsecure", ["Log", "sdk.Runtime", "sdk.Scribe", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h = c("sdk.feature")("https_only_learn_more", "")
                      , i = {};
                    function a(a) {
                        window.location.protocol !== "https:" && (d("Log").log("error", -1, "The method FB.%s can no longer be called from http pages. %s", a, h),
                        c("sdk.feature")("https_only_scribe_logging", !0) && !Object.prototype.hasOwnProperty.call(i, a) && (d("sdk.Scribe").log("jssdk_error", {
                            appId: c("sdk.Runtime").getClientID(),
                            error: "HttpsOnly",
                            extra: {
                                message: a
                    ...
                    function a(a) {
                        ...
                        if (typeof a === "string")
                            if (c("sdk.Runtime").getIsVersioned()) {
                                ...
                                c("ApiClient").graph.apply(c("ApiClient"), arguments);
                        else
                            c("ApiClient").rest.apply(c("ApiClient"), arguments)
                    }
                    g["default"] = a
                }
                ), 98);
                    ...
                    var h = {
                        ...
                        _processRequestResponse: function(a, b) {
                            return function(d) {
                                ...
                                d && (!b && d.frictionless !== null && c("sdk.Dialog")._hideLoader(),
                        ...
                        isAllowed: function(a) {
                            ...
                            if (!a)
                                return !1;
                            if (typeof a === "number")
                                return a in h._allowedRecipients;
                    ...
                    a = {
                        onready: function(a) {
                            ...
                            if (this.nativeReady)
                                ...
                                var b = function b() {
                                    window.removeEventListener(h, b),
                                    this.onready(a)
                                };
                ...
                __d("sdk.Popup", ["sdk.Content", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a, b) {
                        ...
                        a.post ? (f = window.open("about:blank", a.id, e),
                        f && d("sdk.Content").submitToTarget({
                            url: a.url,
                            target: a.id,
                            params: a.params
                    ...
                    function h(a) {
                        ...
                        d.push("top=" + e);
                        d.push("scrollbars=1");
                        a.isOAuth && (d.push("toolbar=0"),
                        (!c("sdk.UA").chrome() || c("sdk.UA").chrome() < 59) && d.push("location=1"));
                        return d.join(",")
                    }
                    g.popup = a
                }
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "guid", "isFacebookDotNetURI", "isFacebookURI", "isInstagramURI", "resolveWindow", "sdk.Event", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    function q(a) {
                        ...
                        c("sdk.Runtime").setEnvironment(a === "canvas" ? c("sdk.Runtime").ENVIRONMENTS.CANVAS : c("sdk.Runtime").ENVIRONMENTS.PAGETAB)
                    }
                    function r(a, b) {
                        if (!b) {
                        ...
                        case "plugin_ready":
                            if (typeof a.name === "string") {
                                ...
                                d("Log").error("plugin_ready message received without a name");
                            break
                        }
                    ...
                    function s(a, b) {
                        ...
                        if (b != null && b !== "native" && !c("isFacebookURI")(e) && !c("isFacebookDotNetURI")(e) && !c("isInstagramURI")(e))
                            return;
                        if (typeof a === "string") {
                            if (/^FB_RPC:/.test(a)) {
                    ...
                    function t(a, b) {
                        a == "facebook" ? (b.relation = i,
                        h.enqueue(b),
                        !c("sdk.Runtime").isCanvasEnvironment() && !h.isStarted() && v(j)) : c("Queue").get(a, {}).enqueue(b)
                    }
                    ...
                    function v(a) {
                        ...
                        f = window.setInterval(function() {
                            if (!h.isStarted() && g > 0)
                                g--,
                                d("Log").debug("resending xdArbiterRegister"),
                                i();
                            else {
                ...
                __d("sdk.openMessenger", ["sdk.UA"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a) {
                        var b, d, e = a.link;
                        a = a.app_id;
                        c("sdk.UA").android() ? (b = "intent://share/#Intent;package=com.facebook.orca;scheme=fb-messenger;S.android.intent.extra.TEXT=" + encodeURIComponent(e) + ";S.trigger=send_plugin;",
                        a && (b += "S.platform_app_id=" + encodeURIComponent(a) + ";"),
                        b += "end",
                        d = i) : (b = "fb-messenger://share?link=" + encodeURIComponent(e),
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Native", "sdk.Popup", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function(a, b, c, d, e, f, g) {
                    ...
                    function k(a) {
                        ...
                        if (c("sdk.Auth").getAuthResponse() && !a.params.scope && !a.params.asset_scope && !a.params.auth_type) {
                            a.params.plugin_prepare || (d("Log").error("FB.login() called when user is already connected."),
                            a.cb && (a == null ? void 0 : a.cb({
                                status: c("sdk.Runtime").getLoginStatus(),
                                authResponse: c("sdk.Auth").getAuthResponse()
                            })));
                            return
                        ...
                        }, e, a.params.plugin_prepare ? "opener.parent" : "opener", !0),
                    ...
                    a = {
                        ...
                        apprequests: {
                            transform: function(a) {
                                ...
                                a.params.frictionless && (c("sdk.Frictionless").isAllowed(a.params.to) && (a.hideLoader = !0),
                    ...
                    var p = {
                        ...
                        getDisplayMode: function(a, b) {
                            if (b.display === "hidden" || b.display === "none" || b.display === "native")
                                return b.display;
                            var e = c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.CANVAS) || c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.PAGETAB);
                            if (e && (d("sdk.modFeatureCheck").forIDs("force_popup_to_canvas_apps_with_id", [c("sdk.Runtime").getClientID()]) || c("sdk.feature")("force_popup_to_all_canvas_app", !1)))
                                return "popup";
                            if (e && !b.display)
                                return "async";
                            if (i(b) || j(b))
                        ...
                        getXdRelation: function(a) {
                            ...
                            if (a === "popup" || a === "touch")
                                return "opener";
                            if (a === "dialog" || a === "iframe" || a === "hidden" || a === "none")
                                return "parent";
                        ...
                        touch: function(a) {
                            ...
                            }, 0) : p.iframe(a) : c("sdk.UA").nativeApp() && !a.ui_created ? (a.frame = a.id,
                        ...
                        async: function(a) {
                            ...
                            i(a.params) || j(a.params) ? (a.params.method = "oauth",
                            a.params.redirect_uri = a.params.next,
                            d("sdk.Extensions").remote.showDialog(a.params, b)) : c("sdk.RPC").remote.showDialog(a.params, b)
                        },
                        "native": function(a) {
                        ...
                        _popupMonitor: function() {
                            ...
                            a && !p._popupInterval ? p._popupInterval = window.setInterval(p._popupMonitor, 100) : !a && p._popupInterval && (window.clearInterval(p._popupInterval),
                        ...
                        _xdChannelHandler: function(a, b) {
                            return c("sdk.XD").handler(function(b) {
                                ...
                                if (b.type == "resize")
                                    ...
                                    b.type == "fireevent" && d("sdk.Event").fire(b.event, b)
                            }, b, !0, null)
                        },
                        ...
                        _xdRecv: function(a, b) {
                            ...
                            if (e)
                                if (e.close)
                                    ...
                                    d("sdk.DOM").containsCss(e, "FB_UI_Hidden") ? window.setTimeout(function() {
                ...
                __d("sdk.ui", ["Assert", "Log", "sdk.Impressions", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    function a(a, b) {
                        ...
                        c("sdk.Runtime").getIsVersioned() && (d("sdk.PlatformVersioning").assertVersionIsSet(),
                        a.version ? d("sdk.PlatformVersioning").assertValidVersion(a.version) : a.version = c("sdk.Runtime").getVersion());
                        ...
                        var e = a.method;
                        a.redirect_uri && (d("Log").warn("When using FB.ui, you should not specify a redirect_uri."),
                ...
                __d("sdk.Auth-public", ["FB", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.AuthUtils", "sdk.Event", "sdk.Runtime", "sdk.ui", "sdk.warnInsecure"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        ...
                        c("FB").provide("", {
                            ...
                            login: function(a, b) {
                                c("sdk.warnInsecure")("login"),
                                c("sdk.Auth").login(a, b)
                            },
                            logout: function(a) {
                                c("sdk.ui")({
                                    method: "auth.logout",
                ...
                __d("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a, b) {
                        b === void 0 && typeof a === "number" && (b = a,
                        a = !0),
                        a || a === void 0 ? (h === null && (h = window.setInterval(function() {
                            k()
                        }, b || 100)),
                        k()) : h !== null && (window.clearInterval(h),
                        h = null)
                    }
                ...
                __d("sdk.Canvas.Plugin", ["Log", "sdk.Runtime", "sdk.UA", "sdk.api"], (function(a, b, c, d, e, f, g) {
                    ...
                    function m(a) {
                        a._hideunity_savedstyle && (a.style.left = a._hideunity_savedstyle.left,
                    ...
                    function p(a) {
                        ...
                        if (b.test(a.getAttribute("wmode")))
                            return !1;
                        for (var c = 0; c < a.childNodes.length; c++) {
                            var d = a.childNodes[c];
                            if (/param/i.test(d.nodeName) && /wmode/i.test(d.name) && b.test(d.value))
                                return !1
                        }
                        return !0
                    }
                ...
                __d("sdk.Canvas.Prefetcher", ["JSSDKCanvasPrefetcherConfig", "sdk.Runtime", "sdk.api"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        if (!c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.CANVAS) || !c("sdk.Runtime").getClientID() || !d("JSSDKCanvasPrefetcherConfig").sampleRate)
                            return;
                        if (Math.random() >= 1 / d("JSSDKCanvasPrefetcherConfig").sampleRate || !d("JSSDKCanvasPrefetcherConfig").enabled || ES(i, "includes", !0, c("sdk.Runtime").getClientID()))
                            return;
                        setTimeout(l, 3e4)
                    }
                    function b(a) {
                ...
                __d("sdk.Canvas-public", ["Assert", "FB", "Log", "sdk.Canvas.Environment", "sdk.Canvas.IframeHandling", "sdk.Canvas.Navigation", "sdk.Canvas.Plugin", "sdk.Canvas.Prefetcher", "sdk.Canvas.Tti", "sdk.Event", "sdk.RPC", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    function a() {
                        ...
                        d("sdk.Event").subscribe("init:post", function(a) {
                            c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.CANVAS) && (c("Assert").isTrue(!a.hideFlashCallback || !a.hidePluginCallback, "cannot specify deprecated hideFlashCallback and new hidePluginCallback"),
                    ...
                    function b() {
                        h(),
                        c("FB").provide("Canvas.Plugin", c("sdk.Canvas.Plugin"))
                    }
                    function e() {
                    ...
                    function f() {
                        ...
                        function b(a, b) {
                            if (a != "canvas.friendsOnlineUpdated")
                                return;
                ...
                __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "isNumberLike"], (function(a, b, c, d, e, f, g) {
                    function a(a) {
                        var b = ES("Object", "assign", !1, {}, a), e, f = b.name || c("guid")(), g = b.root, h = b.style || {
                            border: "none"
                        }, i = b.url, j = b.onload, k = b.onerror;
                        ...
                        b.lazy && (b.loading = "lazy",
                        h.visibility && delete h.visibility);
                        delete b.lazy;
                        a.width != null && c("isNumberLike")(a.width) && (e.width = a.width + "px");
                        a.height != null && c("isNumberLike")(a.height) && (e.height = a.height + "px");
                        b.testid && e.dataset != null && (e.dataset.testid = b.testid,
                        delete b.testid);
                        for (f in b)
                            Object.prototype.hasOwnProperty.call(b, f) && e.setAttribute(f, b[f]);
                    ...
                    var h = c("Type").extend({
                        constructor: function(a, b, e, f) {
                            ...
                            this.subscribe("xd.resize.flow", function(a) {
                                ...
                                d("sdk.PluginUtils").resize(g._iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                g.updateLift(),
                            ...
                            this.subscribe("xd.resize.iframe", function(a) {
                                d("sdk.PluginUtils").resize(g._iframe, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                g._isIframeResized = !0,
                                g.updateLift(),
                                window.clearTimeout(g._timeoutID)
                            });
                            ...
                            this.isFluid() && k.width !== "auto" && (d("sdk.DOM").addCss(this._element, "fb_iframe_widget_fluid_desktop"),
                            !k.width && this._config.full_width && (this._element.style.width = "100%",
                ...
                __d("XFBML", ["Assert", "Log", "runOnce", "sdk.Observable"], (function(a, b, c, d, e, f, g) {
                    ...
                    function n(a) {
                        ...
                        if (b.length === 0)
                            return void 0;
                        if (a.getAttribute("fb-xfbml-state") || !a.childNodes || a.childNodes.length === 0 || a.childNodes.length === 1 && a.childNodes[0].nodeType === 3 || a.children.length === 1 && l(a.children[0], "className") === "fb-xfbml-parse-ignore")
                            return i[b[0]]
                    }
                    function o(a) {
                        var b = {};
                    ...
                    function p(a, b, e) {
                        ...
                        ES("Array", "from", !1, a.getElementsByTagName("*")).forEach(function(a) {
                            ...
                            b = function b() {
                                a.getAttribute("fb-xfbml-state") == "parsed" ? k.subscribe("render.queue", b) : (a.setAttribute("fb-xfbml-state", "parsed"),
                                d.process())
                            }
                            ;
                            b()
                    ...
                    a = {
                        ...
                        parse: function(a, b) {
                            p((a = a) != null ? a : document.body, (a = b) != null ? a : function() {}
                            , !0)
                        },
                        parseNew: function() {
                ...
                __d("sdk.XFBML.Comments", ["IframePlugin", "QueryString", "UrlMap", "sdk.DOM", "sdk.Event", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g) {
                    ...
                    function j(a, b) {
                        ...
                        if (!b.href) {
                            ...
                            e = b.fb_comment_id;
                            e || (e = c("QueryString").decode(document.URL.substring(document.URL.indexOf("?") + 1)).fb_comment_id,
                            e && e.indexOf("#") > 0 && (e = e.substring(0, e.indexOf("#"))));
                            e && (b.fb_comment_id = e)
                        }
                        b.version || (b.version = c("sdk.Runtime").getVersion());
                        b.permalink || (b.width = b.mobile || b.width === "auto" || b.width === "100%" ? "" : b.width ? Math.max(b.width, h) : 550,
                        b.height = 100);
                        if (b.href != null) {
                ...
                __d("ChatPluginStyleUtils", ["LiveChatPluginConstants"], (function(a, b, c, d, e, f, g) {
                    ...
                    function f(a, b, c, d, e, f, g, h) {
                        ...
                        b = b - 2.5;
                        a === "left" && (i = c - 15,
                        d === "none" ? f === "compact" ? i += s : i += r : e === "none" ? d === "ask_us" ? f === "compact" ? i += w : i += u : f === "compact" ? i += v : i += t : d === "ask_us" ? f === "compact" ? i += A : i += y : f === "compact" ? i += z : i += x);
                        c = {
                            bottom: b.toString() + "px",
                            position: "fixed",
                            zIndex: 2147483646,
                ...
                __d("IdleCallbackImplementation", ["performanceNow", "requestAnimationFramePolyfill"], (function(a, b, c, d, e, f, g) {
                    var h, i = [], j = 0, k = 0, l = -1, m = !1, n = 1e3 / 60, o = 2;
                    function p(a) {
                        return a
                    }
                    function q(a) {
                ...
                __d("sdk.XFBML.ChatDOM", ["$InternalEnum", "CORSRequest", "ChatPluginEntryPointIconEnum", "ChatPluginEntryPointLabelEnum", "ChatPluginEntryPointSizeEnum", "ChatPluginSDKPreLoggingUtils", "ChatPluginStyleUtils", "DOMPlugin", "Log", "UrlMap", "getJSEnumSafe", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.IdleCallback", "sdk.XFBML.CustomerChatNew", "sdk.fbt", "sdk.feature", "uuidv4"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        e.$ChatDOMFacade$p_20 = function() {
                            if (this.$ChatDOMFacade$p_2 || this.$ChatDOMFacade$p_1 === i.LOADED)
                                return;
                            if (this.$ChatDOMFacade$p_9 === "none") {
                                ...
                                if (this.$ChatDOMFacade$p_10 === "none") {
                                    ...
                                    d("sdk.DOM").dangerouslySetInnerHtml(this.$ChatDOMFacade$p_3.children[0].children[0], a)
                            }
                        ...
                        e.$ChatDOMFacade$p_16 = function(a, b) {
                            ...
                            if (this.$ChatDOMFacade$p_1 !== i.WAITING)
                                return;
                            ...
                            b.subscribe("xd.mpn.setupIconIframe", function(a) {
                                e.$ChatDOMFacade$p_1 = i.LOADED,
                                e.$ChatDOMFacade$p_19()
                            });
                            this.$ChatDOMFacade$p_23(a);
                            b.process()
                        }
                    ...
                    a = function(a) {
                        ...
                        function b(b, e, f, g, h) {
                            ...
                            i.subscribe("xd.resize.flow", function(a) {
                                ...
                                d("sdk.PluginUtils").resize(i.iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                i.updateLift(),
                            ...
                            i.subscribe("xd.resize.iframe", function(a) {
                                d("sdk.PluginUtils").resize(i.iframe, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)),
                                i.$IframePluginClass$p_2 = !0,
                                i.updateLift(),
                                window.clearTimeout(i.$IframePluginClass$p_1)
                            });
                            ...
                            i.subscribe("xd.refreshLoginStatus", function() {
                                d("sdk.AuthUtils").removeLogoutState(),
                                c("sdk.Auth.LoginStatus").getLoginStatus(ES(i.inform, "bind", !0, babelHelpers.assertThisInitialized(i), "login.status"), !0)
                            });
                            ...
                            i.config.fluid && k.width !== "auto" && (d("sdk.DOM").addCss(i.element, "fbiframe_widget_fluid_desktop"),
                            !k.width && i.config.full_width && (i.element.style.width = "100%",
                ...
                __d("getFacebookOriginForTarget", ["Log"], (function(a, b, c, d, e, f, g) {
                    function a(a, b) {
                        ...
                        window.addEventListener("message", function(c) {
                            c.source === b && c.data.xdArbiterAck && (/\.facebook\.(com|net)$/.test(c.origin) && /^https:/.test(c.origin) ? e === !1 && (e = !0,
                            d("Log").debug("initXdArbiter got xdArbiterAck from " + c.origin),
                            a(c.origin)) : d("Log").error("xdAbiterAck was not from Facebook: ", c.origin))
                        }, !1);
                        b.postMessage({
                            xdArbiterSyn: !0
                        }, "*");
                ...
                __d("sdk.DocumentTitle", [], (function(a, b, c, d, e, f) {
                    var g = document.title
                      ...
                      , k = !1;
                    function l() {
                        h !== null ? !k ? m(h) : n() : (clearInterval(j),
                        j = null,
                        n())
                    }
                    function m(a) {
                        ...
                        b.setState = function(a) {
                            ...
                            try {
                                if (a == null)
                                    ...
                                    if (e == null)
                                        b.setItem(c("sdk.cp.Constants").localStateKey, ES("JSON", "stringify", !1, ES("JSON", "parse", !1, a)));
                                    else {
                                        e = ES("JSON", "parse", !1, e);
                                        a = ES("JSON", "parse", !1, a);
                    ...
                    a = function(a) {
                        ...
                        e.$CustomerChat$p_21 = function(a) {
                            ...
                            var e = a.frameName
                              ...
                              , i = document.createElement("div");
                            f != null && (d("sdk.DOM").dangerouslySetInnerHtml(i, f),
                            ...
                            this.$CustomerChat$p_3 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging(b.$CustomerChat$p_16, "chat_plugin_sdk_icon_iframe_load", b.params),
                        ...
                        e.$CustomerChat$p_27 = function() {
                            this.$CustomerChat$p_2 !== null && this.$CustomerChat$p_7 !== null && this.$CustomerChat$p_9 !== null && this.$CustomerChat$p_5 !== null && this.$CustomerChat$p_11 !== null && !this.$CustomerChat$p_12 && (this.$CustomerChat$p_12 = !0,
                        ...
                        e.$CustomerChat$p_22 = function(a) {
                            ...
                            this.$CustomerChat$p_1 && (e && this.$CustomerChat$p_1.setAttribute(c("sdk.cp.Constants").attribute.mobilePath, e),
                            a && this.$CustomerChat$p_1.setAttribute(c("sdk.cp.Constants").attribute.desktopBottomSpacing, a.toString()));
                            this.$CustomerChat$p_14 = f === "true";
                            this.iframe && (this.iframe.setAttribute("data-testid", "dialog_iframe"),
                        ...
                        e.$CustomerChat$p_33 = function(a, b) {
                            ...
                            this.$CustomerChat$p_13 === null ? c("getFacebookOriginForTarget")(function(a) {
                                d.$CustomerChat$p_13 = a,
                                f(d.$CustomerChat$p_13)
                        ...
                        e.$CustomerChat$p_29 = function(a) {
                            ...
                            if (!this.$CustomerChat$p_14) {
                                ...
                                c("sdk.cp.Constants").animationEvents.forEach(function(e) {
                                    var f = function(e) {
                                        b.$CustomerChat$p_14 && (d("sdk.DOM").setStyle(a, "maxHeight", "0"),
                                        d("sdk.DOM").setStyle(a, "minHeight", "0"),
                                        c("sdk.cp.Constants").animationEvents.forEach(function(b) {
                                            g[b] && (d("DOMEventListener").remove(a, b, g[b]),
                                            delete g[b])
                                        }))
                                    };
                                    g[e] = f;
                    ...
                    a = function(a) {
                        ...
                        function b(b, e, f, g, h) {
                            ...
                            b.createFBButton("fb-button-main-element", d("sdk.SharedStringConstants").buttonStringsFBT.logout, d("sdk.SharedStringConstants").buttonStringsFBT.logoutButtonAriaLabel, r, function(a) {
                                ...
                                c("sdk.Auth").logout(),
                                a && a.detail === 0 && this.fbLoginButton && this.fbLoginButton.style.display !== "none" && this.fbLoginButton.focus()
                ...
                __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "guid", "safeEval", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.Dialog", "sdk.ErrorHandling", "sdk.Impressions", "sdk.PluginUtils", "sdk.Runtime", "sdk.Scribe", "sdk.UIServer", "sdk.XD", "sdk.XFBML.ShadowDOMLoginButton", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.ui"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = c("IframePlugin").extend({
                        constructor: function(a, b, e, f) {
                            if ((d("sdk.modFeatureCheck").forIDs("allow_shadow_dom_for_apps_with_id", [c("sdk.Runtime").getClientID()]) || f["data-shadow-test"] != null && f["data-shadow-test"] === "true") && c("sdk.feature")("allow_shadow_dom", !1) === !0 && f["data-use-continue-as"] !== "true")
                            ...
                            this.subscribe("xd.login_button_click", function(a) {
                                ...
                                if (b.popup) {
                                    ...
                                    c("sdk.feature")("popup_blocker_scribe_logging", !0) && d("sdk.Scribe").log("jssdk_error", {
                                        appId: c("sdk.Runtime").getClientID(),
                    ...
                    a = c("IframePlugin").extend({
                        constructor: function(a, b, e, f) {
                            ...
                            this.subscribe("xd.savePluginGetBlankIframe", function(a) {
                                ...
                                i && (b = d("sdk.DialogUtils").setupNewDarkOverlay(),
                                e(b),
                                d("sdk.Content").append(b),
                                d("sdk.DialogUtils").addDoubleClickAction(b, function() {
                                    return j.forEach(e)
                                }, 5e3));
                                var f = g.setupNewIframeDialog(ES("JSON", "parse", !1, a.data), a.fromIframe);
                                e(f);
                                d("sdk.Content").append(f);
                                var j = [f, b], k = function() {
                                    j.forEach(e),
                                ...
                                var m = window.setInterval(function() {
                                    ...
                                    b.length === 0 && (window.clearInterval(m),
                                    k(),
                    ...
                    a = c("IframePlugin").extend({
                        constructor: function(a, b, e, f) {
                            ...
                            this.subscribe("xd.onVideoAPIReady", function(a) {
                                ...
                                this._videoController = new i(this._iframeOptions.name,this._sharedObservable,this._sharedVideoCache),
                ...
                __d("sdk.api-public", ["ApiClient", "FB", "sdk.Runtime", "sdk.Scribe", "sdk.api", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    var h = c("sdk.feature")("should_log_response_error", !1), i;
                    function a() {
                        var a;
                ...
                __d("sdk.init", ["Log", "ManagedError", "sdk.Cookie", "sdk.Event", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a) {
                        ...
                        if (c("sdk.Runtime").getIsVersioned()) {
                            ...
                            if (a.authResponse)
                                throw new (c("ManagedError"))("Setting authResponse is not supported");
                            ...
                            /number|string/.test(typeof a) && (d("Log").warn("FB.init called with invalid parameters"),
                            a = {
                                apiKey: a
                            }),
                        ...
                        a.cookie && (c("sdk.Runtime").setUseCookie(!0),
                ...
                __d("sdk.init-public", ["FB", "QueryString", "sdk.AppEvents", "sdk.ErrorHandling", "sdk.Event", "sdk.Frictionless", "sdk.XD", "sdk.init"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        ...
                        window.setTimeout(function() {
                            ...
                            window.fbAsyncInit && !window.fbAsyncInit.hasRun && (d("sdk.Event").fire("init:asyncstart"),
                ...
                __d("sdk.Time", ["Log", "sdk.Impressions", "sdk.Runtime", "sdk.URI", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    var h = window.performance, i = h && "now"in h && "getEntriesByName"in h, j, k = {};
                    function a() {
                        function a(a, b) {
                            var e = !1;
                            try {
                        ...
                        if (i) {
                            ...
                            "transferSize"in b && (k.transferSize = b.transferSize,
                ...
                __d("throttle", ["TimeSlice", "TimeSliceInteractionSV", "setTimeout", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
                    ...
                    function h(a, b, d, e, f) {
                        var g = b == null ? 100 : b, h, i = null, j = 0, k = null, l = [], m = c("TimeSlice").guard(function() {
                            j = Date.now();
                            if (i) {
                                var b = ES(function(b) {
                                    a.apply(h, b)
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1011742130","namespace":"FB","message":"' + e.message + '"}}');
